...
Note à savoir : Le site est un recyclage d'un autre site crée il y'a quelques temps avec l'aide de ChatGPT (surtout pour le CSS en fait), je pense que cette information est importante, désolée :(
`;
